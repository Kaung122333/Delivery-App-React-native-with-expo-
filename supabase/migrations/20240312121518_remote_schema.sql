...
ALTER TABLE ONLY "public"."order_item"
    ADD CONSTRAINT "public_order_item_order_id_fkey" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON UPDATE CASCADE ON DELETE CASCADE;

ALTER TABLE ONLY "public"."order_item"
    ADD CONSTRAINT "public_order_item_product_id_fkey" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON UPDATE CASCADE ON DELETE CASCADE;
...
CREATE POLICY "All autheticated user can  do all" ON "public"."orders" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow authenticated users to SELECT" ON "public"."products" TO "authenticated" USING (true) WITH CHECK (true);

CREATE POLICY "Allow autheticated user can do all" ON "public"."order_item" TO "authenticated" USING (true) WITH CHECK (true);
